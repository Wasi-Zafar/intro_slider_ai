...
//    }
          ...
          children: <Widget>[
           ...
           Container(
             alignment: Alignment.center,
              ...
              margin: marginTitle ??
                  EdgeInsets.only(
                      top: height, bottom: 20.0, left: 20.0, right: 20.0),
            ),
   ...
   Container(
              ...
              child: Text(
                ...
                style: styleDescription ??
                    TextStyle(color: Color(0xff7487A9), fontSize: 18.0),
                textAlign: TextAlign.center,
              ...
              margin: marginDescription ??
                  EdgeInsets.fromLTRB(20.0, 10.0, 20.0, 50.0),
            ),
          ],
        ),
      ),
  ...
  List<Widget> renderListDots() {
    ...
    for (int i = 0; i < slides.length; i++) {
      ...
      dots.add(renderDot(sizeDot, currentColor,status));
    }
    return dots;
  }

  Widget renderDot(double radius, Color color,String status) {
    return Container(
      decoration: BoxDecoration(
          color: color, borderRadius: BorderRadius.circular(radius / 2)),
      width: status == "Y" ? 22 : radius,
      height: radius,
